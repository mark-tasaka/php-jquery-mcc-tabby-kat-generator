...
<html>
<head>
<title>Launch Page: Tabby Kat Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="tabbyForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Tabby Kat, Level 1</option>
				<option value="02">Tabby Kat, Level 2</option>
				<option value="03">Tabby Kat, Level 3</option>
				<option value="04">Tabby Kat, Level 4</option>
				<option value="05">Tabby Kat, Level 5</option>
				<option value="06">Tabby Kat, Level 6</option>
				<option value="07">Tabby Kat, Level 7</option>
				<option value="08">Tabby Kat, Level 8</option>
				<option value="09">Tabby Kat, Level 9</option>
				<option value="10">Tabby Kat, Level 10</option>
			  </select>
        ...
        {
            $("#tabbyForm").attr('action', "tabby/tabby"+ $("#level").val() +  ".php");
        });
